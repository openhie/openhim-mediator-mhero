...
Vagrant.configure(2) do |config|
  ...
  config.vm.provision "shell", inline: <<-SHELL
    ...
    echo "openhim-mediator-mhero openhim-config/host string localhost" | debconf-set-selections
    echo "openhim-mediator-mhero openhim-config/port string 8080" | debconf-set-selections
